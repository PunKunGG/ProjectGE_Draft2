                                    ...
                                    <ul class="dropdown-menu">
                                        <li>
                                            <a class="dropdown-item" href="{{ route('admin.edit-equip', $equip->id) }}">
                                                <i class="fas fa-edit me-2"></i>แก้ไขประเภท
                                            </a>
                                        </li>
                                        <li>
                                        <form action="{{ route('admin.delete-equip', $equip->id) }}" method="POST" onsubmit="return confirm('คุณแน่ใจหรือไม่ว่าต้องการลบประเภทอุปกรณ์นี้? การกระทำนี้จะลบไอเทมทั้งหมดที่อยู่ภายใต้ประเภทนี้ด้วย!');">
                                                @csrf
                                                @method('DELETE')
